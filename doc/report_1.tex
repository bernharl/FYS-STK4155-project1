...
We wish to fit Franke's function data and terrain data to a two-dimensional polynomial model on the form $[x,\ y,\ x^2, xy,\ \ y^2, \dots]$,  giving us a design matrix $\bm{X}$ on the form \\
...
\begin{figure}
	...
	\caption{3D plot of the OLS model (dotted) with the generated Franke's function data and added noise.}
\end{figure}
...
\begin{figure}
	...
	\caption{3D plot of the Ridge model (dotted) with the generated Franke's function data with  added noise.}	
\end{figure}
...
\begin{figure}
	...
	\label{fig:3d_Ridge_Franke}
	\caption{3D plot of the Lasso model (dotted) and the generated Franke's function data with  added noise.}	
\end{figure}
