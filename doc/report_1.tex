...
\begin{figure}[H]
    ...
    \caption{OLS regression parameters $\bm{\hat{\beta}}^{\text{OLS}}_F$  of a fourth  order two-dimensional polynomial model  of the generated Franke's function with noise of $\sigma=0.1$, plotted with $68\%$ confidence intervals.}
