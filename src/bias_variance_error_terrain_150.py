...
ax.legend(loc=6)
fig.tight_layout()
fig.savefig("../doc/figs/biasvariancetradeoff_ols_terrain_150_skip.pdf", dpi=1000)
...
ax.legend(loc=6)
fig.tight_layout()
fig.savefig("../doc/figs/biasvariancetradeoff_Ridge_terrain_150_skip.pdf", dpi=1000)
...
ax.legend(loc=6)
fig.tight_layout()
fig.savefig("../doc/figs/biasvariancetradeoff_LASSO_terrain_150_skip.pdf", dpi=1000)
